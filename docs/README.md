...
| --- | --- | --- |
| [Tutorials](tutorials/first-log.md) | Learn by doing | [Log your first day](tutorials/first-log.md) |
| [How-to guides](how-to/) | Get a job done | [Display units](how-to/display-units.md), [colours](how-to/colors.md), [another database](how-to/database-path.md) |

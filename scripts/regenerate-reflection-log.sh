...
# fragments in reflections/active/. Fragments are the source of truth;
# the aggregate is a committed, union-merged view. Deterministic and
# idempotent, so a messy union merge self-heals on rerun.
#
# Usage: regenerate-reflection-log.sh [active-dir] [output-file]
# Defaults: reflections/active  REFLECTION_LOG.md
